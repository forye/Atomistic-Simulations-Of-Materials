...
class spheres(object):
    def __init__(self, Rvt=None, n =3 , Ncolissions = 100, L=1.0, kT=1, speedScale = 1.0 , original_write = True):#0.0001):
        ...
        self.Ns, self.Rv, self.Ncollisions, self.sigma, self.n, self.L = it.init_parameters(n, Ncolissions, Rvt, L)
