...
!compile: gfortran -o spheres spheres.f90 advance_simulation.f90 assign_positions.f90 assign_velocities.f90 compute_diameter.f90 compute_properties.f90 initialize_collisions_table.f90 read_input.f90 retrieve_collision_info.f90 update_collisions_table.f90 validate_input.f90 write_initial.f90 write_properties.f90
...
subroutine spheres
    ...
    integer :: i,icol, jcol    
    integer :: nspheres, ncollisions, Iterations, nc
...
!   
    ...
    do nc = 1, ncollisions
        ...
        call write_properties(nc,mom,kin,tcol,icol,jcol,delta_vel)
...
!    print *, Iterations, "Iterations running time:", t_stop- t_start, " [seconds]"
    ...
    deallocate(vel)
    deallocate(ctime)
!    write(*,*) 'done with spheres.'
!    write(*,*) 'ncollisions:', ncollisions
